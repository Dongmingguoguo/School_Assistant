...
class _LoginRegisterState extends State<LoginRegisterPage> {
  ...
  @override
    Widget build(BuildContext context){
      return new Scaffold(
        appBar: new AppBar(
          title: new Text("Flutter Final Project"),
        ),
        body: new Container(
    ...
    List<Widget> createButtons(){
      if(_formType == FormType.login){
        ...
        return [
          new RaisedButton(
            child: new Text("Create Accout", style: new TextStyle(fontSize: 20.0)),
            textColor: Colors.white,
            color: Colors.blue,
          ...
          new FlatButton(
            child: new Text("Already have an accout? Login", style: new TextStyle(fontSize: 20.0)),
            textColor: Colors.red,
            color: Colors.white,
